...
HD_PWD='C:/Parvathy/project_MB_spec/project_MB_spec.runs/design_mb_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mb_axi_gpio_0_2.tcl
