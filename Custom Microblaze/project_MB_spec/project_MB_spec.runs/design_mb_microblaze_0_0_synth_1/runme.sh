...
HD_PWD='C:/Parvathy/project_MB_spec/project_MB_spec.runs/design_mb_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mb_microblaze_0_0.tcl
