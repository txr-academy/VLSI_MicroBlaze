...
HD_PWD='C:/Parvathy/project_MB_spec/project_MB_spec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_mb_wrapper.tcl -notrace
