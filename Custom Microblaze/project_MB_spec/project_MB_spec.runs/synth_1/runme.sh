...
HD_PWD='C:/Parvathy/project_MB_spec/project_MB_spec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mb_wrapper.tcl
