...
HD_PWD='C:/Parvathy/project_i2c_microblaze/project_i2c_microblaze.runs/design_i2c_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_i2c_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_i2c_axi_uartlite_0_0.tcl
