...
HD_PWD='C:/Parvathy/project_i2c_microblaze/project_i2c_microblaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_i2c_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_i2c_wrapper.tcl -notrace
