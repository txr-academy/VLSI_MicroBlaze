...
HD_PWD='/home/arjun/Vivado_PROJECTS/project_1_MICROB_CUSTOM_BOOT/project_1_MICROB_CUSTOM_BOOT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mico_cust_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mico_cust_wrapper.tcl
