...
HD_PWD='/home/arjun/Vivado_PROJECTS/project__4digit_led/project__4digit_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_4digit_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_4digit_7seg.tcl -notrace
