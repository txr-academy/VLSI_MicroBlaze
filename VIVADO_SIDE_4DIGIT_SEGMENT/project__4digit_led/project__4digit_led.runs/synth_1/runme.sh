...
HD_PWD='/home/arjun/Vivado_PROJECTS/project__4digit_led/project__4digit_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_4digit_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_4digit_7seg.tcl
